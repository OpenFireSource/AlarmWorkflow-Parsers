...
namespace AlarmWorkflow.Parser.Library
{
    ...
    class ILSPassauParser : IParser
    {
        ...
        private static readonly string[] Keywords = new[] { "", "EINSATZNUMMER", "ABSENDER", "NAME", "STRAﬂE", "ORT", "OBJEKT", "KREUZUNG", "STICHWORT B", "STICHWORT SO", "PRIO.", "SCHLAGW", "EINSATZMITTELNAME" };
